// Code for interfacing LCD with PIC18F4550.
// Including libraries
#include <p18f4550.h>
...
#definers PORTEbits.RE0 // register select signal to RE0
#definerw PORTEbits.RE1 // read/write signal to RE1
#defineen PORTEbits.RE2 // enable signal to RE2
// Function Prototypes
void init_LCD(void);      // Function to initialise the LCD
void LCD_command(unsigned char cmd); // Function to
// pass command to the LCD
void LCD_data(unsigned char data); // Function to
// write character to the LCD
void LCD_write_string(static char *str); // Function to write
// string to the LCD
void msdelay(unsigned int time); // Function to generate delay
// Start of Main Program
void main(void)
{
    char var1[] = "SANKET"; // Declare message to be displayed
    char var2[] = "TELUNAGI";
