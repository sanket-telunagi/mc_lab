// Implement timer 0 interrupt to generate a square wave of 10Hz using PIC18F4550.
...
{   _asm 
    goto timer_isr 
    _endasm    //The program is relocated to execute the 
                 //interrupt routine timer_iser
}
#pragma code
